...
class Members(models.Model):
	...
	Married_Status = models.CharField(max_length=10, blank=True,choices=(('Married','Married'),('Single','Single'),))
	Is_Member_Status = models.BooleanField
	Member_Class = models.CharField(max_length=30)
	Family_Class = models.CharField(max_length=10, blank=True, choices=(('P','Parent'),('C','Child'),)) #(Create as Tupel Parent/Children)
